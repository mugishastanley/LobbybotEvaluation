...
public class TestTransforms : MonoBehaviour
{
    ...
    public Matrix4x4 RB2CT()
    {
        ...
        T4[0, 0] = 0.7071068f;      T4[0, 1] = -0.7071068f;     T4[0, 2] = 0;       T4[0, 3] = 0.17f;
        T4[1, 0] = 0.7071068f;      T4[1, 1] = 0.7071068f;      T4[1, 2] = 0.0f;    T4[1, 3] = 0.01f;
        T4[2, 0] = 0f;              T4[2, 1] = 0f;              T4[2, 2] = 1;       T4[2, 3] = -0.02f;
        T4[3, 0] = 0f;              T4[3, 1] = 0f;              T4[3, 2] = 0f;      T4[3, 3] = 1.0f;
        return T4;
