...
namespace CLARTE.Backport {
	...
	[Serializable]
	public class Tuple<T1> : Collections.IStructuralEquatable, Collections.IStructuralComparable, IComparable, ITuple {
		...
		public override Boolean Equals(Object obj) {
			return ((Collections.IStructuralEquatable) this).Equals(obj, EqualityComparer<Object>.Default);
		}

		Boolean Collections.IStructuralEquatable.Equals(Object other, IEqualityComparer comparer) {
		...
		Int32 IComparable.CompareTo(Object obj) {
			return ((Collections.IStructuralComparable) this).CompareTo(obj, Comparer<Object>.Default);
		}

		Int32 Collections.IStructuralComparable.CompareTo(Object other, IComparer comparer) {
		...
		public override int GetHashCode() {
			return ((Collections.IStructuralEquatable) this).GetHashCode(EqualityComparer<Object>.Default);
		}

		Int32 Collections.IStructuralEquatable.GetHashCode(IEqualityComparer comparer) {
			return comparer.GetHashCode(m_Item1);
		}

		Int32 ITuple.GetHashCode(IEqualityComparer comparer) {
			return ((Collections.IStructuralEquatable) this).GetHashCode(comparer);
		}
	...
	[Serializable]
	public class Tuple<T1, T2> : Collections.IStructuralEquatable, Collections.IStructuralComparable, IComparable, ITuple {
	...
	[Serializable]
	public class Tuple<T1, T2, T3> : Collections.IStructuralEquatable, Collections.IStructuralComparable, IComparable, ITuple {
	...
	[Serializable]
	public class Tuple<T1, T2, T3, T4> : Collections.IStructuralEquatable, Collections.IStructuralComparable, IComparable, ITuple {
	...
	[Serializable]
	public class Tuple<T1, T2, T3, T4, T5> : Collections.IStructuralEquatable, Collections.IStructuralComparable, IComparable, ITuple {
	...
	[Serializable]
	public class Tuple<T1, T2, T3, T4, T5, T6> : Collections.IStructuralEquatable, Collections.IStructuralComparable, IComparable, ITuple {
	...
	[Serializable]
	public class Tuple<T1, T2, T3, T4, T5, T6, T7> : Collections.IStructuralEquatable, Collections.IStructuralComparable, IComparable, ITuple {
	...
	[Serializable]
	public class Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> : Collections.IStructuralEquatable, Collections.IStructuralComparable, IComparable, ITuple {
		...
		Int32 Collections.IStructuralEquatable.GetHashCode(IEqualityComparer comparer) {
			...
			System.Diagnostics.Debug.Assert(false, "Missed all cases for computing Tuple hash code");
			return -1;
		}
